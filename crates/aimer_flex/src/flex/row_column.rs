...
impl Column {
    ...
    #[inline] pub fn vertical_alignment(mut self, alignment: BoxAlignment) -> Self {
    ...
    ///
    /// The default is [`BoxAlignment::Start`].
    #[inline] pub fn horizontal_alignment(mut self, alignment: BoxAlignment) -> Self {
    ...
    #[inline] pub fn gaps(mut self, gaps: impl Into<LayoutSpacing>) -> Self {
        self.gaps = gaps.into();
        self
    }
    ...
    #[inline] pub fn overflow(mut self, overflow: OverflowBehavior) -> Self {
    ...
    /// [`AnyWidget`] type.
    #[inline] pub fn box_children<W: Widget + 'static>(
        self,
    ...
    /// iterator.
    #[inline] pub fn children<W: Widget>(self, children: impl IntoIterator<Item = W>) -> Column<W> {
        Column {
            vertical_alignment: self.vertical_alignment,
            horizontal_alignment: self.horizontal_alignment,
            gaps: self.gaps,
...
impl Row {
    ...
    #[inline] pub fn children<W: Widget>(self, children: impl IntoIterator<Item = W>) -> Row<W> {
        Row {
            vertical_alignment: self.vertical_alignment,
            horizontal_alignment: self.horizontal_alignment,
            gaps: self.gaps,
    ...
    #[inline] pub fn add_child<W: Widget + 'static>(mut self, child: W) -> Self {
    ...
    /// like [`Vec::insert`].
    #[inline] pub fn insert_child<W: Widget + 'static>(mut self, index: usize, child: W) -> Self {
