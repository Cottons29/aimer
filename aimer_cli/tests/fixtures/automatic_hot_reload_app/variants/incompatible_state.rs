...
const EXPECTED_LABEL: &str = "INCOMPATIBLE";
const EXPECTED_INCREMENT: u32 = 1;
const EXPECT_INCOMPATIBLE: bool = true;
...
impl StatefulWidget for Counter {
    ...
    fn create_state(self) -> Self::State {
        CounterState {
            ...
            socket: std::rc::Rc::new(NativeSocket),
        }
    }
}
